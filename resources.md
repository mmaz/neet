...
*Do you have a resource you want to add to this list? Did you find something frustrating or unhelpful and want to remove it? Pull-requests welcome! If students feel it is useful, we will integrate this list into the official website.*
